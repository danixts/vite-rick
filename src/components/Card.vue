...
<template>
  <div
    class="group flex flex-row justify-start items-center bg-gradient-to-br from-primary-700 to-primary-600 rounded-md hover:bg-primary-600/80 transition-all cursor-pointer hover:scale-105 hover:shadow-2xl shadow-xl relative"
  >
